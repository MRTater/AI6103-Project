...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.1\linewidth]{f3.png} % Adjust the width and image file name as needed
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\linewidth]{f4.jpg} % Adjust the width and image file name as needed
    \caption{64*64, T=300, linear, sythesized image via backward process}
    \label{fig:figure4}
\end{figure}

\bibliography{aaai23}
% https://www.youtube.com/watch?v=a4Yfz2FxXiY&t=983s
